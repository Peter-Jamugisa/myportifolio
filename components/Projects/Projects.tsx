        ...
        <div className="justify-center items-center h-96">
            ...
            <Accordion type="single" collapsible className="w-full mt-10">
                <AccordionItem value="item-1">
                    ...
                    <AccordionContent className="flex flex-col gap-2 w-1/3">
                        <Button onClick={() => window.open('https://mind-peace-two-eta.vercel.app/', '_blank')} className="font-bold bg-green-700">Mind Peace</Button>
